...
public partial class BaseDal
{
            ...
            string[] columns)
    {
        ...
        var attributes = autoIncrementAttributeProperty?.GetCustomAttributes(true)?? [];
        var autoIncrementAttribute = Array.Find(attributes,
            x => x is AutoIncrementAttribute) as AutoIncrementAttribute;
